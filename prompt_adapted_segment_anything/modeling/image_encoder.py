...
class ImageEncoderViT(nn.Module):
    def __init__(
        ...
        self.neck = Neck(embed_dim, out_chans, use_lora=use_lora)
...
class Neck(nn.Module):
    ...
    def __init__(self, embed_dim, out_chans, use_lora=False):
        super().__init__()
        if use_lora:
...
class Block(nn.Module):
    ...
    def __init__(
        ...
        self.mlp = MLPBlock(embedding_dim=dim, mlp_dim=int(dim * mlp_ratio), act=act_layer, use_lora=use_lora)
